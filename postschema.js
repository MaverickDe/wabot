...
const { pgTable, varchar, boolean, timestamp,primaryKey } = require("drizzle-orm/pg-core");
;

 const groupContacts = pgTable("group_contacts", {
...
// Timestamp","SenderName","PhoneNumber","Message","GroupName","ChatType
 const groupMessages = pgTable("group_messages", {
